...
REM   Uses the folder this .bat lives in — no hardcoded drive letters.
REM ============================================================
cd /d "%~dp0"

REM Dashboard may pre-set CONTACT, SEND, and SKIP_PROMPTS=1 (no console prompts).
...
REM ---- Find Python (Windows-native; CDP is localhost so WSL is not needed) ----
set "PY="
